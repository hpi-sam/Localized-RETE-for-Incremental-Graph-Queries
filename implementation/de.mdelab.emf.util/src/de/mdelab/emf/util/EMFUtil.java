...
public class EMFUtil {
	...
	public static void writeMDELabModel(Collection<EObject> model, List<EMFDelta> deltas, String path) {
		...
		Object oldFactory = Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().get(extension);
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(extension, new MDELabResourceFactoryImpl());
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(extension, oldFactory);
	}
	...
	public static boolean matchesSuperType(EClass type, EClass superType) {
