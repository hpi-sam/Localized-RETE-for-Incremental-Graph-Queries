...
public class StoryPatternModelIndex implements EMFMetaData {
	...
	protected Map<EStructuralFeature, Collection<FeatureSpecification>> featureSpecs;
	...
	public StoryPatternModelIndex() {
		...
		this.featureSpecs = new HashMap<EStructuralFeature, Collection<FeatureSpecification>>();
	}
	...
	public double getDomainSize(EClassifier type) {
		return domains.get(type).size();
	}

	@Override
	public double getDomainSize(FeatureSpecification feature) {
		return references.get(feature).size();
	}
