...
import de.mdelab.mlsdm.incremental.rete.nodes.ocl.MLSDMLWExpressionInterpreter;
import de.mdelab.mlsdm.incremental.rete.util.ReteMatch;
...
public class ReteExpressionFilter extends ReteDistributor implements ChangeListener {
	...
	protected Map<EStructuralFeature, Collection<Integer>> featureAccesses;
	protected Map<EStructuralFeature, Map<Object, Collection<ReteTuple>>> registeredTuples; 	// TODO make this an explicit
																								// (multi-)indexer?									
	...
	protected void registerTuple(EStructuralFeature key, Object object, ReteTuple tuple) {
	...
	protected void unregisterTuple(EStructuralFeature key, Object object, ReteTuple tuple) {
		Map<Object, Collection<ReteTuple>> tuples = registeredTuples.get(key);
	...
	private boolean isMatchingChange(SDMChangeEvent change) {
		return featureAccesses.containsKey(change.getType());
	}
