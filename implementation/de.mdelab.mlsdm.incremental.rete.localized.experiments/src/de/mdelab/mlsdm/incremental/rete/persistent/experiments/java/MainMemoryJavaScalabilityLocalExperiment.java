...
public class MainMemoryJavaScalabilityLocalExperiment extends MainMemoryJavaScalabilityReteExperiment {

	public MainMemoryJavaScalabilityLocalExperiment(String metaDataPath, int packageNumber, boolean measureMemory) {
	...
	public static void main(String[] args) {
		...
		MainMemoryJavaScalabilityLocalExperiment experiment = new MainMemoryJavaScalabilityLocalExperiment(metaDataFile, packageNumber, measureMemory);
