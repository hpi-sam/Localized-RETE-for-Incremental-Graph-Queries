...
public class MainMemoryJavaIncrementalVIATRAExperiment extends MainMemoryJavaIncrementalExperiment<JavaQueryID> {
	...
	public MainMemoryJavaIncrementalVIATRAExperiment(boolean measureMemory) {
		super(measureMemory);
	}

	@Override
	protected void doPerformExperiment(MoDiscoDeltaReader model, JavaQueryID query) {
	...
	protected void initializeReteNet(MoDiscoDeltaReader model) {
		engine = createEngine(model.getModelRoots());
	...
	public static void main(String[] args) {
		if(args.length < 3) {
			System.out.println("3 arguments: dataDir, queryID, measureMemory");
			return;
		}
		...
		MainMemoryJavaIncrementalVIATRAExperiment experiment = new MainMemoryJavaIncrementalVIATRAExperiment(measureMemory);
