...
public class MainMemoryJavaScalabilityGlobalExperiment extends MainMemoryJavaScalabilityReteExperiment {

	protected ReteSubgraphFilter subgraphFilter;
	
	public MainMemoryJavaScalabilityGlobalExperiment(String metaDataPath, int packageNumber, boolean measureMemory) {
		super(metaDataPath, packageNumber, measureMemory);
	}

	@Override
	protected ReteQueryManager createQueryManager(Model model) {
	...
	protected void initializeSubgraphFilter(Model model) {
		if(Experiment.FILTER_RESULTS) {
	...
	public static void main(String[] args) {
		...
		MainMemoryJavaScalabilityGlobalExperiment experiment = new MainMemoryJavaScalabilityGlobalExperiment(metaDataFile, packageNumber, measureMemory);
