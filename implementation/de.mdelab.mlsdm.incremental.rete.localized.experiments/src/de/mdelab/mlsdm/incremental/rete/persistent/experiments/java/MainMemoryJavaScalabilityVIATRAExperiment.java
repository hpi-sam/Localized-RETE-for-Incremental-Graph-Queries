...
public class MainMemoryJavaScalabilityVIATRAExperiment extends MainMemoryJavaScalabilityExperiment<JavaQueryID> {
	...
	public MainMemoryJavaScalabilityVIATRAExperiment(int packageNumber, boolean measureMemory) {
		super(packageNumber, measureMemory);
	}

	@Override
	protected void doPerformExperiment(Model model, JavaQueryID query) {
	...
	public static AdvancedViatraQueryEngine createEngine(Model root) throws ViatraQueryException {
		...
		EMFScope scope = new EMFScope(root);
	...
	public static void main(String[] args) throws ViatraQueryException, IOException {
		...
		MainMemoryJavaScalabilityVIATRAExperiment experiment = new MainMemoryJavaScalabilityVIATRAExperiment(packageNumber, measureMemory);
